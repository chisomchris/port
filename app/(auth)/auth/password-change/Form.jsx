    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            ...
            <div className='relative mb-4 pb-6 '>
                ...
                <input name='otp' id='otp' {...formik.getFieldProps('otp')} className='block py-2 px-4  outline-none border-solid border-[1px]  focus:border-2' />
