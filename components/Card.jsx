...
export const Card = ({ name, email, mobile, color, id, show }) => {
    ...
    return (
        <div className={'py-4 px-6 rounded-xl text-white ' + color}>
            ...
            <div className='flex items-center gap-x-4 gap-y-2 mt-4 flex-wrap'>
                ...
                <button className='flex items-center bg-white gap-4 py-1 px-6 text-red-400 rounded-md ' onClick={() => { show(id) }}>Delete <FaTrashAlt /></button>
            </div>
        </div>
    )
}
